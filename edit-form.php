<?php 
  ...
  $query = "SELECT * FROM formulir WHERE id = $id LIMIT 1";
...
<html lang="en">
  <head>
    ...
    <title>Edit Data Formulir</title>
  </head>
        ...
        <div class="col-md-8 offset-md-2">
          <div class="card">
            <div class="card-header">
              EDIT FORMULIR (CETAKAN)
            </div>
            <div class="card-body">
            <a href="read-form.php"><button type="submit" class="btn btn-primary">KEMBALI</button></a>
