<?php 
  ...
  $query = "SELECT * FROM materai WHERE id = $id LIMIT 1";
      ...
      <div class="row">
        <div class="col-md-8 offset-md-2">
          <div class="card">
            ...
            <div class="card-body">
            <a href="read-matrai.php"><button type="submit" class="btn btn-primary">KEMBALI</button></a>
              <form action="update-matrai.php" method="POST">
